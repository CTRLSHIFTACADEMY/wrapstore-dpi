    ...
    try {
      ...
      const { data: invoice, error: invErr } = await supabase
        ...
        .insert({
          ...
          created_by: user?.id,
          sale_channel: 'POS',          // ← omnichannel marker (existing column)
          channel: 'offline',            // ← channel tracking (migration_channel_tracking.sql)
          order_status: 'confirmed',     // ← fulfilment status
        })
        .select()
        .single()
